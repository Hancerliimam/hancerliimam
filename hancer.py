...
def usage():
        print '---------------------------------------------------'
        print 'to attack:'
        print '#Windows: hancer.py http://www.exemplo.com.br/'
        print '#Linux: python hancer.py http://www.exemplo.com.br/'
        print "\a"
...
|  _  ||  _  || . ` || |    |  __| |    / | |      | |    | |  | |\/| ||  _  || |\/| |
| | | || | | || |\  || \__/\| |___ | |\ \ | |____ _| |_  _| |_ | |  | || | | || |  | |
\_| |_/\_| |_/\_| \_/ \____/\____/ \_| \_|\_____/ \___/  \___/ \_|  |_/\_| |_/\_|  |_/
